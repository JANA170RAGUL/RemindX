...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex select-none bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 p-16 flex-col justify-between border-r border-white/10">
        ...
        <div className="relative z-10 space-y-6 max-w-lg">
          ...
          >
            Master your schedule with autonomous intelligence.
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Seamlessly combine Google Calendar, Todoist, and Notion into a unified futuristic workspace powered by advanced predictive AI.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your corporate credentials to access your smart dashboard.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              type="button" 
              onClick={() => toast.info('Google SSO Simulated')}
              className="h-12 px-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 font-semibold text-xs text-foreground flex items-center justify-center gap-2 transition-all shadow-sm"
            >
            ...
            <button 
              type="button" 
              onClick={() => toast.info('GitHub SSO Simulated')}
              className="h-12 px-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 font-semibold text-xs text-foreground flex items-center justify-center gap-2 transition-all shadow-sm"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[11px] uppercase tracking-wider text-muted-foreground font-semibold">Or continue with email</span>
            <div className="flex-1 h-px bg-border/40" />
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" defaultChecked className="w-4 h-4 rounded bg-white/10 border-white/20 text-primary focus:ring-primary/50" />
